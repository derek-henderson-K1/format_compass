 ...
 *
 * @module     format_compass/local/courseindex/section
 * @class      format_compass/local/courseindex/section
 * @copyright  2023 KnowledgeOne
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

import SectionTitle from 'format_compass/local/courseindex/sectiontitle';
import DndSection from 'format_compass/local/courseeditor/dndsection';
...
export default class Component extends DndSection {
    ...
    _refreshPageItem({element, state}) {
        ...
        const section = state.section.get(this.id);
        if (section && section.indexcollapsed && !element.pageItem?.isStatic) {
