 ...
 *
 * @module     format_compass/local/courseindex/sectiontitle
 * @class      format_compass/local/courseindex/sectiontitle
 * @copyright  2023 KnowledgeOne
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

import DndSectionItem from 'format_compass/local/courseeditor/dndsectionitem';
...
export default class Component extends DndSectionItem {
    ...
    create(descriptor) {
        ...
        if (this.section != undefined && this.section.number > 0) {
