 ...
 *
 * @module     format_compass/local/courseeditor/exporter
 * @class      format_compass/local/courseeditor/exporter
...
export default class {
    ...
    sectionDraggableData(state, sectionid) {
        //Custom dropdata for the assessments header
        if(sectionid == "assessmentscutoff") {
            return {
                type: 'assessmentscutoff',
                id: "assessmentscutoff",
                name: "",
                number: '',
            };
        } else {
