...
/**
 *
 * This code is based on Collapsed topics code
 *
    ...
    Y.use('node', 'event-mouseenter', function(){
        ...
        var colourpopup = {
            ...
            setColour : function(e) {
                ...
                this.swatch.setStyle('backgroundColor', displaycolor);
            },
            ...
            pickColour : function(e) {
                var colour = this.determineColour(e);
                var colourdisplay = '#' + colour;
                this.input.set('value', colourdisplay);
                this.input.focus();
                this.swatch.setStyle('backgroundColor', '#' + colour);
