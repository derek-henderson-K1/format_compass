...
class format_compass_test extends \advanced_testcase {
    ...
    public function test_get_section_name() {
        ...
        $numsections = 5;
        $course = $generator->create_course(['numsections' => $numsections, 'format' => 'compass'],
            ['createsections' => true]);
    ...
    public function test_update_inplace_editable() {
        ...
        $this->setUser($user);
        $course = $this->getDataGenerator()->create_course(['numsections' => 5, 'format' => 'compass'],
            ['createsections' => true]);
    ...
    public function test_default_course_enddate() {
        ...
        $params = ['format' => 'compass', 'numsections' => 5, 'startdate' => 1445644800];
    ...
    public function test_get_view_url() {
        ...
        $generator = $this->getDataGenerator();
        $course1 = $generator->create_course(['format' => 'compass']);
