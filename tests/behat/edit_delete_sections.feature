@format @format_compass
Feature: Sections can be edited and deleted in compass format
  ...
  Scenario: View the default name of the general section in compass format
    When I edit the section "0"
    Then the field "Custom" matches value "0"
    And the field "New value for Section name" matches value "General"

  Scenario: Edit the default name of the general section in compass format
  ...
  Scenario: View the default name of the second section in compass format
    When I edit the section "2"
    Then the field "Custom" matches value "0"
    And the field "New value for Section name" matches value "Topic 2"

  Scenario: Edit section summary in compass format
    When I edit the section "2" and I fill the form with:
      | Summary | Welcome to section 2 |
    Then I should see "Welcome to section 2" in the "Topic 2" "section"

  Scenario: Edit section default name in compass format
    When I edit the section "2" and I fill the form with:
      | Custom | 1                      |
  ...
  @javascript
  Scenario: Inline edit section name in compass format
  ...
  Scenario: Deleting the last section in compass format
  ...
  Scenario: Deleting the middle section in compass format
  ...
  @javascript
  Scenario: Adding sections at the end of a compass format
  ...
  @javascript
  Scenario: Adding sections between topics in compass format
